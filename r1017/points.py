...
SEED_POINTS = (
    ...
    SeedPoint("MONTREAL_CORRECTED_ANCHOR", "Montreal corrected",
              45.508822, -73.554075, 30.0, 25.0,
              "APPROXIMATE_PUBLIC_ELEVATION", STRICT,
              "S3_surface_shell_candidate",
              168500683, "1202616713", "A_training",
              "canonical surface word; never project the raw wire"),
