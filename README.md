...
**Current release: [v4.9.0](https://github.com/andrew867/rgcs/releases/tag/v4.9.0)**
...
- **Status at the release commit (v4.9.0):** 1840 tests passed
...
# expect: see docs/v4/RELEASE_METADATA.json, at the v4.9.0 release commit
```
