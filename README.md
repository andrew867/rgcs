...
**Current release: [v4.8.1](https://github.com/andrew867/rgcs/releases/tag/v4.8.1)**
...
- **Status at the release commit (v4.5.0):** 1219 tests passed
...
# expect: see docs/v4/RELEASE_METADATA.json, at the v4.8.1 release commit
```
