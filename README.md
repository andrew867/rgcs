...
**Current release: [v5.0.0](https://github.com/andrew867/rgcs/releases/tag/v5.0.0)**
...
- **Status at the release commit (v5.0.0):** 2166 tests passed
...
# expect: see docs/v4/RELEASE_METADATA.json, at the v5.0.0 release commit
```
