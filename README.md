...
**Current release: [v4.5.1](https://github.com/andrew867/rgcs/releases/tag/v4.5.1)**
...
- **Status at the release commit (v4.5.0):** 939 tests passed
...
# expect: see docs/v4/RELEASE_METADATA.json, at the v4.5.1 release commit
```
