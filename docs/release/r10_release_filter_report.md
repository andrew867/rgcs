...
Generated: `2026-08-03T21:17:41.761807-02:30`
Base: `8077e04395b04464ad57d99a4b6b49e6b72a2e60`
Result: **PASS**
...
|---|---:|---|
| `35312e29c8db` | 21 | R10.71: Phyrll/Terra v0.6 - exact spine, ring masks, proxy, filter, calibration |
| `4e762851d083` | 22 | R10.72 v0.7: arithmetic stops carrying the physics; optimizer carries it |
| `a10a3bb11a1c` | 5 | Composed loading + phase-lag 2-D sweep: recipe found, loophole closed |
| `710e5947c80e` | 8 | R10.73: constrained recipe becomes a bench-drive spec and falsification test |
| `dfab636c4bf5` | 74 | R10.74: add annular ring development kit scaffold |
...
- Review: **1974**
- Files with excluded-term hits: **81**
...
| `rgcs_terra_release/release_filter.py` | none | ascii, crabwood, glyph message, glyph-message, glyph_message, message decode, message decoding, message-decode, message-decoding, message_decode, message_decoding, plaintext, private comms, private-comms, private_comms | private |
...
| `tests/test_terra_public_release_filter.py` | none | ascii, crabwood, glyph message, glyph-message, glyph_message, message decode, message decoding, message-decode, message-decoding, message_decode, message_decoding, plaintext, private comms, private-comms, private_comms | private |
