...
Tested commit: `cdb702288bc7aa7083851719d1942df4d8a29a3e`

Tested tree: `b2d0201dc208c1ab685cfba8ff785f885c89cc87`

## Full Suite

```text
python -m pytest tests rgcs_ardk/tests -q --basetemp build/pytest-r10-public-full-final3 --junitxml=build/r10-public-full-final3-junit.xml
```
...
- Errors: **0**
- Xfails: **0**
- Pytest runtime: **1,561.58 seconds**
- Wall runtime: **1,566.3 seconds**
...
- Release filter, release builder, and privacy gates: **63 passed**.
...
`build/r10-public-full-final3-junit.xml`. It is generated evidence and is
