...
def render_scad(cone: ConeDesign, coil: dict | None = None) -> str:
    ...
    if coil is not None:
        ...
        lines += [
            ...
            "    for (i = [0 : steps - 1]) {",
            "        z = band_bottom_mm +"
            " (band_top_mm - band_bottom_mm) * i / steps;",
            "        ang = handed * (360 * (z - band_bottom_mm)"
            " / groove_pitch_mm) + phase_rad * 180 / PI;",
