...
def render_scad(cone: ConeDesign, coil: dict | None = None,
    ...
    if coil is not None:
        ...
        lines += [
            ...
            f"helix_angle_deg = {paths['helix_angle_deg']:.4f};",
            f"rise_per_turn_mm = {paths['rise_per_turn_mm']:.4f};",
            f"n_starts = {paths['n_starts_per_coil']};",
            ...
            "    twist_deg = -handed * 360 * band_h_mm"
            " / rise_per_turn_mm;",
